...
{
    public partial class OperationsRus : Form

    {
        


        public OperationsRus()
        {
            InitializeComponent();
        ...
        private void popolnit_Click(object sender, EventArgs e)
        {
            if (balance.Text.Length != 0)
            {
                ...
                PopovnitRus fm1 = new PopovnitRus();
        ...
        private void Tranzaksii_Click(object sender, EventArgs e)
        {
            if (balance.Text.Length != 0)
            {
                ...
                TranzaksiiRus perevodi = new TranzaksiiRus();
        ...
        private void balance_TextChanged_1(object sender, EventArgs e)
        {
            if (balance.Text.Length == 0)
            {
        ...
        private void OperationsRus_Move(object sender, EventArgs e)
        {
