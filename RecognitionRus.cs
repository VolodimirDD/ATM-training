...
{
    public partial class RecognitionRus : Form
    {

        
        public RecognitionRus()
        {
            ...
            label1.Text = "Пожалуйста , подождите... Идет процесс распознавания карты!";        //Присваем label1 текст
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            EnterPinRus Form5 = new EnterPinRus();
        ...
        private void RecognitionRus_Move(object sender, EventArgs e)
        {
