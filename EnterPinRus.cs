...
{
    public partial class EnterPinRus : Form
    {
        public EnterPinRus()
        {
            InitializeComponent();
            ...
            label2.Text = "Введите ваш pin-code!";
        ...
        private void pinkod_KeyPress(object sender, KeyPressEventArgs e)        //Ограничения на ввод
        {
        ...
        private void enter_Click_1(object sender, EventArgs e)
        {
            ...
            if ((pinkod.Text.Length > 4) || (pinkod.Text.Length < 4))
            {
             ...
             label1.Text = ("Введите корректный pin!");
            ...
            else
            {
                ...
                if (a < 2)
                {
                    ...
                    if (pinkod.Text == "1111")
                    {
                        ...
                        OperationsRus opr = new OperationsRus();
                    ...
                    else
                    {
                        ...
                        a = a + 1; label1.Text = "Неверный PIN-code";
                ...
                else
                {
                    ...
                    BlokirovkaRus gm123 = new BlokirovkaRus();      //Создаем экземпляр формы
        ...
        private void EnterPinRus_Move(object sender, EventArgs e)
        {
