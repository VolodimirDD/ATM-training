...
{
    public partial class EnterPinEng : Form
    {
        public EnterPinEng()
        {
            ...
            label2.Text = "Enter your pin code!";
        ...
        private void enter_Click(object sender, EventArgs e)
        {
            ...
            if ((pinkod.Text.Length > 4) || (pinkod.Text.Length < 4))
            {
                ...
                label1.Text = ("Enter the correct pin!");
            ...
            else
            {
                ...
                if (a < 2)
                {
                    ...
                    if (pinkod.Text == "1111")
                    {
                        ...
                        OperationsEng opr = new OperationsEng();
                    ...
                    else
                    {
                        ...
                        a = a + 1; label1.Text = "Invalid pin-code";
                ...
                else
                {
                    ...
                    BlokirovkaEng gm123 = new BlokirovkaEng();      //Создаем экземпляр формы
        ...
        private void EnterPinEng_Move(object sender, EventArgs e)
        {
        ...
        private void pinkod_TextChanged(object sender, EventArgs e)
        {
