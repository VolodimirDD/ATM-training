...
{
    public partial class TranzaksiiRus : Form
    {
        public TranzaksiiRus()
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                label3.Text = "Введите корректный номер телефона!";
        ...
        private void pop_Click(object sender, EventArgs e)
        {
            if (vvodkolichestva.Text != "0")
            {
                if (vvodkolichestva.Text != String.Empty)
                {
                    ...
                    if (long.Parse(vvodkolichestva.Text) > long.Parse(balance.Text))
                    {
                        ...
                        label4.Text = "Недостаточно денег на счету!";
                ...
                else
                {
                    ...
                    label4.Text = "Введите сумму перевода!";
            ...
            else
            {
                ...
                label4.Text = "Некорректное значение!";
        ...
        private void perevodnakartu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                label2.Text = "В карте 16 цыфр.Проверьте правильность ввода!";
        ...
        private void perevod_Click(object sender, EventArgs e)
        {
            if (summa.Text != "0")
            {
                if (summa.Text != String.Empty)
                {
                    ...
                    if (int.Parse(summa.Text) > int.Parse(balance.Text))
                    {
                        ...
                        label5.Text = "Недостаточно денег на счету!";
                ...
                else
                {
                    ...
                    label5.Text = "Введите сумму перевода!";
            ...
            else
            {
                ...
                label5.Text = "Некорректное значение!";
        ...
        private void timer1_Tick_1(object sender, EventArgs e)
        {
            ...
            ToUpPhoneNumberRus Form63 = new ToUpPhoneNumberRus();

            Form63.Show();

        }

        private void TranzaksiiRus_Move(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            ToUpCardRus g1 = new ToUpCardRus();
