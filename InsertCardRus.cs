...
{
    public partial class InsertCardRus : Form
    {



        public InsertCardRus()
        {
            ...
            label1.Text = "Вставьте свою карту, пожалуйта!";        //Присвоение текста программно
        ...
        private void InsertCardRus_Load(object sender, EventArgs e) 
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            RecognitionRus recognition = new RecognitionRus();        //Создаем экземпляр формы
        ...
        private void vstavka_DragLeave(object sender, EventArgs e)
        {
            ...
            label1.Text = "Вставьте карту в отмеченную зону!";

        }

        private void InsertCardRus_Move(object sender, EventArgs e)
        {
