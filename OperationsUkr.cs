...
{
    public partial class OperationsUkr : Form
    {
        public OperationsUkr()
        {
            InitializeComponent();
        ...
        private void OperationsUkr_Move(object sender, EventArgs e)
        {
        ...
        private void popolnit_Click(object sender, EventArgs e)
        {
            if (balance.Text.Length != 0)
            {
                ...
                PopovnitUkr fm1 = new PopovnitUkr();
        ...
        private void Tranzaksii_Click(object sender, EventArgs e)
        {
            if (balance.Text.Length != 0)
            {
                ...
                TranzaksiiUkr perevodi = new TranzaksiiUkr();
